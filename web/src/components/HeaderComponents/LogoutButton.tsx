...
export function LogoutButton() {
  ...
  return (
    <Menu as="div" className="ml-3 relative">
      {({ open }) => (
        <>
          <Menu.Button className="pb-5 ml-auto mt-auto transition-all duration-100">
          ...
          >
            ...
            >
                ...
                <button onClick={() => Logout()} className="w-full p-3 bg-green-500 hover:bg-green-600 rounded-lg">Sim</button>
            </Menu.Items>
          </Transition>
        </>
      )}
