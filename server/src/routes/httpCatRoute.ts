...
// export const httpCatRouter = express.Router();
...
// httpCatRouter.get("/", (req, res) => {
//   const catData = statusCode.map(async function (status) {
//     return await axios.get(`https://http.cat/${status}`);
//   });
